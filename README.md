...
- [ ] [Cheat sheet](http://bigocheatsheet.com/) *
    ...
    * Skipping for now (either a repetition of something I kinda understand or just wanna come back to this later)
    p Paid Course
    x Not interested in watching for wtvr reason
    ```
...
- ### Arrays
    ...
    - [ ] Description:
        ...
        - ~~[UCBerkley CS61B - Linear and Multi-Dim Arrays (video)](https://youtu.be/Wp8oiO_CZZE?t=15m32s)~~ x
        - ~~[Basic Arrays (video)](https://www.lynda.com/Developer-Programming-Foundations-tutorials/Basic-arrays/149042/177104-4.html)~~ p
        - ~~[Multi-dim (video)](https://www.lynda.com/Developer-Programming-Foundations-tutorials/Multidimensional-arrays/149042/177105-4.html)~~ p
        ...
        - ~~[Jagged Arrays (video)](https://www.lynda.com/Developer-Programming-Foundations-tutorials/Jagged-arrays/149042/177106-4.html)~~ p
        - ~~[Resizing arrays (video)](https://www.lynda.com/Developer-Programming-Foundations-tutorials/Resizable-arrays/149042/177108-4.html)~~ p
